      ...
      //  fabSwitcher = findViewById(R.id.fab_switcher);
        ...
        ItemClickListener itemClickListener = new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                Toast.makeText(Video_tools.this, position+"", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Video_tools.this,VideoPlayingActivity.class);
...
/*
        ...
        videoAdapter = new VideoAdapter(this,mData,isDark,itemClickListener);
